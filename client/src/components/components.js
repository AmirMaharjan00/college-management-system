...
export const Breadcrumb = ( props ) => {
    const { headLabel = 'Account', currentPageLabel = 'All Books', middle = true, middleLabel = 'Account', middleLink = '/dashboard/account' } = props
    return <div className="breadcrumb-wrapper">
        ...
        <ul className="cmg-breadcrumb" id="cmg-breadcrumb">
            ...
            { middle && <li className="breadcrumb-item"><Link to={ middleLink }>{ middleLabel }</Link></li> }
...
export const ActionButton = ( props ) => {
    const Global = useContext( GLOBALCONTEXT ),
        ...
        { setFormMode, label = 'New Book', extendFunction, classes = '', showIcon = true } = props,
