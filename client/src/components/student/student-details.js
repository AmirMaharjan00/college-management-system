import { useState, useEffect, useMemo, useId, useCallback, useContext, createContext } from "react";
...
import ExamAccordions from "./ExamAccordions.js";
import {
  faCalendarMinus,
  faGraduationCap,
  faTable,
...
export const StudentDetails = () => {
  const location = useLocation(),
    ...
    { profile, role, gender, status, motherTongue = 'nepali', language = 'nepali', secondaryContact, contact, motherName, fatherName, motherProfile, fatherProfile, motherContact, fatherContact, motherEmail, fatherEmail, address } = userDetails,
    studentObj = {
      motherName, fatherName, motherProfile, fatherProfile, motherContact, fatherContact, motherEmail, fatherEmail, address
    }
  ...
  return (
    <STUDENT.Provider value={ studentObj }>
      <main className="cmg-main student-details" id="cmg-main">
        <div className="page-header">
          <div className="dashboard-intro">
            <h2 className="user-name">{`${ capitalizeText( role ) }s Details`}</h2>
            <ul className="cmg-breadcrumb" id="cmg-breadcrumb">
              ...
              <li className="breadcrumb-item">
                <Link
                  to={`/dashboard/${userDetails?.role}s`}
                >{`${ capitalizeText( role ) }s`}</Link>
              </li>
              <li className="breadcrumb-item">{`${ capitalizeText( role ) } Details`}</li>
            </ul>
          </div>
          <TodaysDate />
        </div>
          ...
          <div className="student-sidebar">
            <div className="student-profile student-sidebar-card">
              <div className="student-profile__header">
                <figure className="student-profile__avatar">
                  <img src={ profile } />
                </figure>
                <div className="student-profile__info">
                  <span className={ `student-profile__status ${( status === 'online' ) ? 'student-profile__status--active' : ''}` }>
              ...
              <div className="student-profile__section student-profile__basic-info">
                ...
                <div className="student-profile__details">
                  <p className="student-profile__detail">
                    ...
                    <span className="student-profile__value">{ userId }</span>
                  </p>
                  <p className="student-profile__detail">
                  ...
                  <p className="student-profile__detail">
                    ...
                    <span className="student-profile__value">{ capitalizeText( motherTongue ) }</span>
                  </p>
                  <p className="student-profile__detail">
                    <span className="student-profile__label">Language</span>
                    <span className="student-profile__value">{ capitalizeText( language ) }</span>
                  </p>
                </div>
            ...
            <div className="student-profile__section student-profile__contact-info student-sidebar-card">
              ...
              <div className="student-profile__contact">
                ...
                <div className="student-profile__contact-detail">
                  <p className="student-profile__label">Primary Phone Number</p>
                  <p className="student-profile__value">{ contact }</p>
                </div>
              </div>
              { secondaryContact && <div className="student-profile__contact">
                <span className="student-profile__icon icon"></span>
                <div className="student-profile__contact-detail">
                  <p className="student-profile__label">Secondary Phone Number</p>
                  <p className="student-profile__value">{ secondaryContact }</p>
                </div>
              </div> }
            </div>

            <div className="sibling-info student-sidebar-card">
              <h3 className="sibling-info__title student-profile__section-title title">
          ...
          <div className="student-main">
            <div className="student-main__tabs">
              <ul className="student-main__tab-list">
                <li
                  className={`student-main__tab-item ${
                    tab === "details" ? "active" : ""
                  }`}
                ...
                <li
                  className={`student-main__tab-item ${
                    tab === "time-table" ? "active" : ""
                  }`}
                  onClick={() => handleTabClick("time-table")}
                >
                  <span className="icon">
 ...
 */
const Details = () => {
  const { motherName = '-', fatherName = '-', motherProfile, fatherProfile, motherContact = '-', fatherContact = '-', motherEmail = '-', fatherEmail = '-', address } = useContext( STUDENT )
  console.log( fatherProfile )
  return (
    <>
        ...
        <div className="personal-info__list">
          <div className="parent-card">
            <div className="parent-card__profile">
              <figure className="parent-card__avatar">
                <img src={ fatherProfile }/>
              </figure>
              <div className="parent-card__details">
                <h3 className="parent-card__name">{ fatherName }</h3>
                <span className="parent-card__role">Father</span>
              </div>
            </div>
            <div className="parent-card__contact">
              <p className="parent-card__label">Phone</p>
              <span className="parent-card__value">{ fatherContact }</span>
            </div>
            <div className="parent-card__contact">
              <p className="parent-card__label">Email</p>
              <span className="parent-card__value">{ fatherEmail }</span>
            </div>
          ...
          <div className="parent-card">
            <div className="parent-card__profile">
              <figure className="parent-card__avatar">
                <img src={ motherProfile }/>
              </figure>
              <div className="parent-card__details">
                <h3 className="parent-card__name">{ motherName }</h3>
                <span className="parent-card__role">Mother</span>
              </div>
            </div>
            <div className="parent-card__contact">
              <p className="parent-card__label">Phone</p>
              <span className="parent-card__value">{ motherContact }</span>
            </div>
            <div className="parent-card__contact">
              <p className="parent-card__label">Email</p>
              <span className="parent-card__value">{ motherEmail }</span>
            </div>
            <button className="parent-card__reset-pass"></button>
          </div>
        </div>
    ...
    <>
      <div className="leave-container">
        <div className="leave-tabs sub-card">
          <button
            className={`leave-tabs__button ${
              tab === "leaves" ? "leave-tabs__button--active" : ""
            }`}
          ...
          <button
            className={`leave-tabs__button ${
              tab === "attendance" ? "leave-tabs__button--active" : ""
            }`}
          ...
          <table className="leave-table">
            ...
            <tbody>
              <tr>
                ...
                <td>1</td>
                <td>07 May 2024</td>
                <td className="leave-table__status leave-table__status--approved">
                  <span>Approved</span>
                </td>
              </tr>
              <tr>
        ...
        <div className="attendance-section">
          <div className="attendance-header">
            ...
            <div className="fees__filter-button dropdown">
              ...
              <span className="fees-dropdown-icon">
  ...
  return (
    <main className="cmg-main">
      <div className="cmg-routines-wrapper">
        <h1 className="cmg-title">Exams & Results</h1>

        <div className="cmg-routine-content">
          <ExamAccordions data={examResults} />
        </div>
      </div>
    </main>
  );
